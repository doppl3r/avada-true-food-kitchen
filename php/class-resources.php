    ...
    class TFK_Resources {
        public function __construct() {
            if (!is_admin()) {
                ...
                wp_register_script('scripts-tfk', get_stylesheet_directory_uri() . '/js/scripts-tfk.js');
		        ...
		        wp_register_style('styles-tfk', get_stylesheet_directory_uri() . '/css/styles-tfk.css');
            }
        }
    }
?>